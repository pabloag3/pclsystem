 ...
 * @author tatoa
 */
public class IngresoPorFueroPorMesDTO {
    ...
    public IngresoPorFueroPorMesDTO() {
    }

    public IngresoPorFueroPorMesDTO(int codFuero, String tipoFuero, int enero, int febrero, int marzo, int abril, int mayo, int junio, int julio, int agosto, int septiembre, int octubre, int noviembre, int diciembre) {
